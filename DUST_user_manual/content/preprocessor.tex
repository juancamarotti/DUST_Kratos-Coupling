...
elements will be generated, while in case of surface panels $2\cdot nelem\_chord$ elements will be produced, 
...
\begin{itemize}
  ...
  \item \opt{cosineLE} for a half cosine refined only on leading edge (suggested for surface panels). 
  \item \opt{cosineTE} for a half cosine refined only on the trailing edge (not recommended). 
  ...
  \item \opt{geoseriesLE} for a half geometric series refined only on leading edge. 
  In this case the parameter \param{r} represents the growth ratio.
  \item \opt{geoseriesTE} for a half geometric series refined only on the trailing edge (not recommended).
  In this case the parameter \param{r} represents the growth ratio.
  \item \opt{geoseriesHI} for a geometric series distribution, refined both on the leading and trailing edge, 
...
\begin{itemize}
  ...
  \item \opt{geoseriesIB} for a half geometric series refined only inboard.
  In this case the parameter \param{r} represents the growth ratio.
  \item \opt{geoseriesOB} for a half geometric series refined only outboard.
  In this case the parameter \param{r} represents the growth ratio.  
\end{itemize}
...
\end{enumerate}
\textit{\textcolor{red}{Remark}}: each element of the aerodynamic table is separated by a white space in free format in a single. 
